...
const LOTS_OF_REMOVABLES = [
  ...
  { id: 7, color: "white", col: 23, row: 0, removed: false },
  { id: 8, color: "white", col: 17, row: 5, removed: false },
  { id: 9, color: "white", col: 17, row: 6, removed: false },
  { id: 10, color: "white", col: 17, row: 0, removed: false },
  { id: 11, color: "white", col: 17, row: 1, removed: false },
  { id: 12, color: "white", col: 17, row: 2, removed: false },
  { id: 13, color: "white", col: 17, row: 3, removed: false },
  { id: 14, color: "white", col: 17, row: 4, removed: false },
