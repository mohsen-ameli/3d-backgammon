...
export const DEFAULT_POS: CheckerType[] = [
...
// Default checker positions
export const TWO_REMOVED: CheckerType[] = [
  ...
  { id: 4, color: "white", col: 11, row: 2, removed: false },
  { id: 5, color: "white", col: 11, row: 3, removed: false },
  { id: 6, color: "white", col: -1, row: 0, removed: true },
  { id: 7, color: "white", col: -1, row: 1, removed: true },
  { id: 8, color: "white", col: 16, row: 0, removed: false },
  { id: 9, color: "white", col: 16, row: 1, removed: false },
  { id: 10, color: "white", col: 18, row: 0, removed: false },
  { id: 11, color: "white", col: 18, row: 1, removed: false },
  { id: 12, color: "white", col: 18, row: 2, removed: false },
  { id: 13, color: "white", col: 20, row: 0, removed: false },
  { id: 14, color: "white", col: 20, row: 1, removed: false },

  { id: 15, color: "black", col: 0, row: 0, removed: false },
  { id: 16, color: "black", col: 4, row: 0, removed: false },
  { id: 17, color: "black", col: 4, row: 1, removed: false },
  { id: 18, color: "black", col: 5, row: 0, removed: false },
  { id: 19, color: "black", col: 5, row: 1, removed: false },
  { id: 20, color: "black", col: 6, row: 0, removed: false },
  { id: 21, color: "black", col: 6, row: 1, removed: false },
  { id: 22, color: "black", col: 7, row: 0, removed: false },
  { id: 23, color: "black", col: 7, row: 1, removed: false },
  { id: 24, color: "black", col: 12, row: 0, removed: false },
  { id: 25, color: "black", col: 12, row: 1, removed: false },
  { id: 26, color: "black", col: 12, row: 2, removed: false },
  { id: 27, color: "black", col: 12, row: 3, removed: false },
...
export const LOTS_OF_REMOVABLES: CheckerType[] = [
  { id: 0, color: "white", col: 0, row: 0, removed: false },
  { id: 1, color: "white", col: 18, row: 0, removed: false },
  { id: 2, color: "white", col: 19, row: 0, removed: false },
  { id: 3, color: "white", col: 20, row: 0, removed: false },
  { id: 4, color: "white", col: 21, row: 0, removed: false },
  { id: 5, color: "white", col: 22, row: 0, removed: false },
  { id: 6, color: "white", col: 16, row: 0, removed: false },
  { id: 7, color: "white", col: 16, row: 1, removed: false },
  { id: 8, color: "white", col: 16, row: 2, removed: false },
  { id: 9, color: "white", col: 16, row: 3, removed: false },
  { id: 10, color: "white", col: 16, row: 4, removed: false },
  { id: 11, color: "white", col: 16, row: 5, removed: false },
  { id: 12, color: "white", col: 16, row: 6, removed: false },
  { id: 13, color: "white", col: 16, row: 7, removed: false },
  { id: 14, color: "white", col: 16, row: 8, removed: false },
...
export const STACKED_REMOVABLES: CheckerType[] = [
  { id: 0, color: "white", col: -1, row: 0, removed: true },
  { id: 1, color: "white", col: -1, row: 1, removed: true },
  { id: 2, color: "white", col: -1, row: 2, removed: true },
  { id: 3, color: "white", col: -1, row: 3, removed: true },
  { id: 4, color: "white", col: -1, row: 4, removed: true },
  { id: 5, color: "white", col: -1, row: 5, removed: true },
  { id: 6, color: "white", col: -1, row: 6, removed: true },
  { id: 7, color: "white", col: 22, row: 0, removed: false },
  { id: 8, color: "white", col: 23, row: 0, removed: false },
  { id: 9, color: "white", col: 23, row: 1, removed: false },
  { id: 10, color: "white", col: 23, row: 2, removed: false },
  { id: 11, color: "white", col: 23, row: 3, removed: false },
  { id: 12, color: "white", col: 23, row: 4, removed: false },
  { id: 13, color: "white", col: 23, row: 5, removed: false },
  { id: 14, color: "white", col: 23, row: 6, removed: false },

  { id: 15, color: "black", col: -2, row: 0, removed: true },
  { id: 16, color: "black", col: -2, row: 1, removed: true },
  { id: 17, color: "black", col: -2, row: 2, removed: true },
  { id: 18, color: "black", col: -2, row: 3, removed: true },
  { id: 19, color: "black", col: -2, row: 4, removed: true },
  { id: 20, color: "black", col: -2, row: 5, removed: true },
  { id: 21, color: "black", col: -2, row: 6, removed: true },
  { id: 22, color: "black", col: 7, row: 0, removed: false },
  { id: 23, color: "black", col: 7, row: 1, removed: false },
  { id: 24, color: "black", col: 7, row: 2, removed: false },
  { id: 25, color: "black", col: 7, row: 3, removed: false },
  { id: 26, color: "black", col: 7, row: 4, removed: false },
  { id: 27, color: "black", col: 7, row: 5, removed: false },
...
export const BLACK_ALMOST_WON: CheckerType[] = [
  { id: 0, color: "black", col: -4, row: 0, removed: false },
  { id: 1, color: "black", col: -4, row: 1, removed: false },
  { id: 2, color: "black", col: -4, row: 2, removed: false },
  { id: 3, color: "black", col: -4, row: 3, removed: false },
  { id: 4, color: "black", col: -4, row: 4, removed: false },
  { id: 5, color: "black", col: -4, row: 5, removed: false },
  { id: 6, color: "black", col: -4, row: 6, removed: false },
  { id: 7, color: "black", col: -4, row: 7, removed: false },
  { id: 8, color: "black", col: -4, row: 8, removed: false },
  { id: 9, color: "black", col: -4, row: 9, removed: false },
  { id: 10, color: "black", col: -4, row: 10, removed: false },
  { id: 11, color: "black", col: -4, row: 11, removed: false },
  { id: 12, color: "black", col: -4, row: 12, removed: false },
  { id: 13, color: "black", col: -4, row: 13, removed: false },
  { id: 14, color: "black", col: 0, row: 0, removed: false },

  { id: 15, color: "white", col: 22, row: 0, removed: false },
  { id: 16, color: "white", col: 22, row: 1, removed: false },
  { id: 17, color: "white", col: 5, row: 0, removed: false },
  { id: 18, color: "white", col: 4, row: 0, removed: false },
  { id: 19, color: "white", col: 3, row: 0, removed: false },
  { id: 20, color: "white", col: 2, row: 0, removed: false },
  { id: 21, color: "white", col: 1, row: 0, removed: false },
  { id: 22, color: "white", col: 6, row: 0, removed: false },
  { id: 23, color: "white", col: 13, row: 0, removed: false },
  { id: 24, color: "white", col: 13, row: 1, removed: false },
  { id: 25, color: "white", col: 13, row: 2, removed: false },
  { id: 26, color: "white", col: 13, row: 3, removed: false },
  { id: 27, color: "white", col: 13, row: 4, removed: false },
  { id: 28, color: "white", col: 13, row: 5, removed: false },
  { id: 29, color: "white", col: 13, row: 6, removed: false },
]
