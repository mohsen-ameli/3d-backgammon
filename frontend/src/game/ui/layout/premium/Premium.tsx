  ...
  return (
    <>
      <div className="grid h-full grid-cols-1 gap-2 text-black sm:grid-cols-2">
        <div className="flex h-full min-h-[200px] flex-col rounded-xl bg-slate-300 px-2 py-4">
        ...
        <div className="relative flex h-full min-h-[200px] flex-col rounded-xl bg-slate-300 px-2 py-4">
          <h1 className="text-center text-xl font-semibold">Premium</h1>
          <div className="my-2 border-b-2 border-orange-300" />
          <ul className="my-2">
            <li>
              <FontAwesomeIcon icon={faCheck} color="green" /> Access to the game
