...
const LayoutBtn = (props_: BtnProps) => {
  ...
  return (
    <button
      className="flex h-[40px] w-[40px] items-center justify-center rounded-full bg-red-200 text-sm duration-200 ease-in-out hover:bg-red-300 lg:h-[50px] lg:w-[50px] lg:text-lg"
      onClick={handleClick}
      {...props}
    >
      {children}
