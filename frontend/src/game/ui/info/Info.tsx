  ...
  return (
    <div className="flex flex-col gap-y-5">
      <div className="">
        ...
        <div className="grid size-full grid-cols-3 gap-4 text-sm text-white lg:text-lg">
          <div className="flex w-full flex-col items-center gap-y-2 rounded-xl bg-[#47474762] py-4">
